...
export const SchoolRequestType = [
  ...
  { id: 3, name: 'ขออนุญาตให้ประกอบวิชาชีพทางการศึกษาโดยไม่มีใบอนุญาตประกอบวิชาชีพ' },
  { id: 4, name: 'ขอสร้างเลขประจำตัวคุรุสภาสำหรับชาวต่างชาติ' },
  {
    id: 5,
    name: 'ขอเปลี่ยนแปลง/แก้ไขหนังสืออนุญาตประกอบวิชาชีพ ไม่มีหนังสืออนุญาต',
  },
...
export const staffLicenseTypes = [
  {
    value: 1,
    label: 'หนังสืออนุญาตประกอบวิชาชีพครู',
  },
  {
    value: 2,
    label: 'หนังสืออนุญาตประกอบวิชาชีพผู้บริหารสถานศึกษา',
  },
  {
    value: 3,
    label: 'หนังสืออนุญาตประกอบวิชาชีพผู้บริหารการศึกษา',
  },
  {
    value: 4,
    label: 'หนังสืออนุญาตประกอบวิชาชีพศึกษานิเทศก์',
  },
  {
    value: 5,
    label: 'หนังสืออนุญาตให้ประกอบวิชาชีพทางการศึกษาโดยไม่มีใบอนุญาตประกอบวิชาชีพครู',
  },
  {
    value: 6,
    label:
...
export enum SchoolRewardType {
  'ด้านการจัดการเรียนรู้' = 1,
  'ด้านสื่อและเทคโนโลยีเพื่อการเรียนรู้' = 2,
  'ด้านการบริหารและการจัดการสถานศึกษา' = 3,
  'ด้านการส่งเสริมและพัฒนาผู้เรียนให้เต็มศักยภาพ' = 4,
  'ด้านการวัดและการประเมินผล' = 5,
}
