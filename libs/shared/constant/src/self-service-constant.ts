...
export const SelfRequestType = [
  { id: 1, name: 'ขอขึ้นทะเบียนหนังสืออนุญาตประกอบวิชาชีพ' },
  { id: 2, name: 'ขอต่ออายุหนังสืออนุญาตประกอบวิชาชีพ' },
  { id: 3, name: 'ขอเปลี่ยนแปลง/แก้ไขหนังสืออนุญาตประกอบวิชาชีพ' },
  { id: 4, name: 'ขอใบแทนหนังสืออนุญาตประกอบวิชาชีพ' },
...
export enum SelfServiceRequestType {
  'ขอขึ้นทะเบียนหนังสืออนุญาตประกอบวิชาชีพ' = '01',
  'ขอต่ออายุหนังสืออนุญาตประกอบวิชาชีพ' = '02',
  'ขอเปลี่ยนแปลง/แก้ไขหนังสืออนุญาตประกอบวิชาชีพ' = '03',
  'ขอใบแทนหนังสืออนุญาตประกอบวิชาชีพ' = '04',
...
export enum RefundReason {
  ...
  'ชำระเงินซ้ำ' = 3,
  'ชำระเงินผิดประเภท' = 4,
  'ขอยกเลิกกการขึ้นทะเบียนรับหนังสืออนุญาต' = 5,
  'ขอยกเลิกการต่ออายุหนังสืออนุญาต' = 6,
  'อื่นๆ' = 7,
}

export enum SelfPrefixTh {
  'ไม่ระบุ' = 0,
  'นาย' = 1,
  'นาง' = 2,
  'นางสาว' = 3,
