...
@Component({
  selector: 'ksp-zform-multi-attachment',
  templateUrl: './zform-multi-attachment.component.html',
  styleUrls: ['./zform-multi-attachment.component.scss'],
})
export class ZFormMultiAttachmentComponent {
  @Input() titleClass = ``;
  @Input() titleNote = '';
  ...
  constructor(public dialog: MatDialog, private fileService: FileService) {
    console.log( "zform-multi-attachmen : " ,this.mode)
  }
