...
@Component({
  templateUrl: './publish-confirmation-list.component.html',
  styleUrls: ['./publish-confirmation-list.component.scss'],
  standalone: true,
  imports: [
    CommonModule,
    TopNavComponent,
...
export class PublishConfirmationListComponent {
  //mode!: EthicsMode;
  ...
  onSubmit(id: any) {
    this.router.navigate(['publish', 'confirmation', id]);
  }
}
