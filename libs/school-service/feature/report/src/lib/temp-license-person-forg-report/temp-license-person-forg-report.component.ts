...
@UntilDestroy()
@Component({
  selector: 'ksp-temp-license-person-forg-report',
  templateUrl: './temp-license-person-forg-report.component.html',
  styleUrls: ['./temp-license-person-forg-report.component.scss'],
})
export class TempLicensePersonForgReportComponent implements OnInit {
