...
@UntilDestroy()
@Component({
  selector: 'ksp-temp-license-person-thai-report',
  templateUrl: './temp-license-person-thai-report.component.html',
  styleUrls: ['./temp-license-person-thai-report.component.scss'],
})
export class TempLicensePersonThaiReportComponent implements OnInit {
