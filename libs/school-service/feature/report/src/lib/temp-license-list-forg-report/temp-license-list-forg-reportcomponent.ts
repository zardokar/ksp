...
@UntilDestroy()
@Component({
  selector: 'ksp-temp-license-list-forg-report',
  templateUrl: './temp-license-list-forg-report.component.html',
  styleUrls: ['./temp-license-list-forg-report.component.scss'],
})
export class TempLicenseListForgReportComponent implements OnInit {
