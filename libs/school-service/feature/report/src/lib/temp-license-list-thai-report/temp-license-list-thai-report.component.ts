...
@UntilDestroy()
@Component({
  selector: 'ksp-temp-license-list-thai-report',
  templateUrl: './temp-license-list-thai-report.component.html',
  styleUrls: ['./temp-license-list-thai-report.component.scss'],
})
export class TempLicenseListThaiReportComponent implements OnInit {
