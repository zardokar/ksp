...
export const menu: MenuConfig[] = [
  ...
  },
  {
    ...
    subMenu: [
      {
        label:
          'ขอหนังสืออนุญาตประกอบวิชาชีพโดยไม่มีใบอนุญาตประกอบวิชาชีพ (ชาวไทย)',
  ...
  },
  {
    ...
    subMenu: [
      {
        label:
          'รายงานสถิติผู้ขอรับหนังสืออนุญาตให้ประกอบวิชาชีพทางการศึกษาโดยไม่มีใบอนุญาตประกอบวิชาชีพ',
        path: '/report/temp-license',
      },
      {
        label:
          'รายงานรายชื่อผู้มีหนังสืออนุญาตให้ประกอบวิชาชีพทางการศึกษาโดยไม่มีใบอนุญาตประกอบวิชาชีพ (ชาวไทย)',
        path: '/report/temp-license-person-thai',
      },
      {
        label:
          'รายงานรายชื่อผู้มีหนังสืออนุญาตให้ประกอบวิชาชีพทางการศึกษาโดยไม่มีใบอนุญาตประกอบวิชาชีพ (ชาวต่างชาติ)',
        path: '/report/temp-license-person-forg',
      },
      {
        label:
          'รายงานรายชื่อผู้ยื่นคำขอหนังสืออนุญาตให้ประกอบวิชาชีพทางการศึกษาโดยไม่มีใบอนุญาตประกอบวิชาชีพ (ชาวไทย)',
        path: '/report/temp-license-list-thai',
      },
      {
        label:
          'รายงานรายชื่อผู้ยื่นคำขอหนังสืออนุญาตให้ประกอบวิชาชีพทางการศึกษาโดยไม่มีใบอนุญาตประกอบวิชาชีพ (ชาวต่างชาติ)',
        path: '/report/temp-license-list-forg',
      },
    ],
  },
  {
