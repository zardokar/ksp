...
export const menu: MenuConfig[] = [
  ...
  },
  {
    ...
    subMenu: [
      ...
      {
        label:
          'รายงานรายชื่อผู้มีหนังสืออนุญาตประกอบวิชาชีพ โดยไม่มีหนังสืออนุญาตประกอบวิชาชีพ (ชาวไทย)',
        path: '/report/test-report',
      },
      {
        label:
          'รายงานรายชื่อผู้มีหนังสืออนุญาตประกอบวิชาชีพ โดยไม่มีหนังสืออนุญาตประกอบวิชาชีพ (ชาวต่างชาติ)',
        path: '/report/test-report',
      },
      {
        label:
          'รายงานรายชื่อผู้ยื่นคำขอหนังสืออนุญาตประกอบวิชาชีพ โดยไม่มีหนังสืออนุญาตประกอบวิชาชีพ (ชาวไทย)',
        path: '/report/test-report',
      },
      {
        label:
          'รายงานรายชื่อผู้ยื่นคำขอหนังสืออนุญาตประกอบวิชาชีพ โดยไม่มีหนังสืออนุญาตประกอบวิชาชีพ (ชาวต่างชาติ)',
        path: '/report/test-report',
      },
    ],
  },
