...
export const eLicenseMenu: MenuConfig[] = [
  ...
  //       label:
  //         'รายการแบบคำขอหนังสืออนุญาตให้ประกอบวิชาชีพโดยไม่มีใบอนุญาต',
  //     },
  //     {
  //       path: '/temp-license/consider-list/1',
  //       label:
  //         'พิจารณารับรองหนังสืออนุญาตให้ประกอบวิชาชีพโดยไม่มีใบอนุญาต',
  //     },
  //   ],
  // },
  // /*-------------------------------------------------------------------------------*/
  ...
  //   icon: 'assets/images/icon-sidenav/paper.svg',
  //   label:
  //     'แบบคำขอหนังสืออนุญาตให้ประกอบวิชาชีพโดยไม่มีใบอนุญาต(ชาวต่างชาติ)',
  //   path: '',
  //   isExpanded: false,
